    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div>
                ...
                <TextInput id="apellidos" type="text" class="mt-1 block w-full" v-model="form.apellidos" required autofocus
            ...
            <div class="mt-4">
                ...
                <TextInput id="telefono" type="number" class="mt-1 block w-full" v-model="form.telefono" required
