                        ...
                        ">
                                    <li>
                                        <NavLink href="/" :active="route().current('dashboard')">
                                            <img src="../../img/logopng.png" class="block h-9 w-auto fill-current text-gray-800" alt="">
                                        </NavLink>
                                    </li>
            
                                    <li class=" text-cyan-600 text-lg hover:text-black">
                                        <NavLink href="/entradas" :active="$page.component === 'Entradas'">Entradas
                                        </NavLink>
                                    </li>
                                    <li class=" text-cyan-600 text-lg hover:text-black">
                                        <NavLink href="/reservas" :active="$page.component === 'Mis reservas'">Mis reservas
                                        </NavLink>
                                    </li>

                                    <li class=" text-cyan-600 text-lg hover:text-black">
                                        <NavLink href="/login" :active="$page.component === 'Login'">Login</NavLink>
                                    </li>
                                    <li class=" text-cyan-600 text-lg hover:text-black">
